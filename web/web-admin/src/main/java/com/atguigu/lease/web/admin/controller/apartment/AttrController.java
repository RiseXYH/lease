...
public class AttrController {
    ...
    public Result removeAttrKeyById(@RequestParam Long attrKeyId) {
        ...
        //删除属性值
        LambdaQueryWrapper<AttrValue> objectLambdaQueryWrapper = new LambdaQueryWrapper<>();
        objectLambdaQueryWrapper.eq(AttrValue::getAttrKeyId, attrKeyId);
        attrValueService.remove(objectLambdaQueryWrapper);
        return Result.ok();
    }
